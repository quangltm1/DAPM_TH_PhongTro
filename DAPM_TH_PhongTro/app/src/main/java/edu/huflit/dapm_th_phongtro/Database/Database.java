...
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_HOPDONGCCCDCHUTRO;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_HOPDONGCCCDNGUOITHUE;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_HOPDONGNGAYBATDAU;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_HOPDONGNGAYKETTHUC;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_HOPDONGNOIDUNG;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_HOPDONGTEN;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_HOPDONGTENCHUTRO;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_HOPDONGTENNGUOITHUE;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_HOPDONGTIENCOC;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_HOPDONGTIENDIEN;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_HOPDONGTIENNUOC;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_HOPDONGTIENPHONG;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.COLUMN_TRANGTHAIHOPDONG;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.TABLE_HOPDONG;
import static edu.huflit.dapm_th_phongtro.Database.DBHelper.TABLE_PHONGTRO;
...
public class Database {
    ...
    public static boolean updateRoomStatus(SQLiteDatabase db, long phongId, int trangThai) {
        ...
        return db.update(TABLE_PHONGTRO, contentValues, DBHelper.COLUMN_PHONGID_PHONG + "=" + phongId, null) > 0;
    }

    public static boolean updateHopDongStatus(SQLiteDatabase db, String hopDongTen, int trangThai) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_TRANGTHAIHOPDONG, trangThai);
        return db.update(TABLE_HOPDONG, contentValues, COLUMN_HOPDONGTEN + "=" + hopDongTen, null) > 0;
    }
    ...
    public void capNhatThongTinPhongTro(PhongTro phongTro) {
        ...
        db.update(TABLE_PHONGTRO, values, DBHelper.COLUMN_PHONGID_PHONG + " = ?",
